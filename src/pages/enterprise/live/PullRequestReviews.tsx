...
import { GitPullRequest, Users, TrendingUp, Calendar, RefreshCw, AlertCircle } from 'lucide-react'
    ...
    return (
      <div className="flex items-center justify-center h-64">
        <div className="text-center">
          ...
          <p className="text-slate-400">Loading PR review metrics...</p>
        </div>
      </div>
    )
  }
    ...
    return (
      <div className="space-y-6">
        <div>
          ...
          <p className="text-slate-400">GitHub Copilot pull request review metrics</p>
        </div>
        ...
        <div className="bg-slate-800 border border-slate-700 rounded-xl p-12 text-center">
          ...
          <p className="text-slate-400 mb-6 max-w-md mx-auto">
            No PR review metrics found. Please download your enterprise metrics from the Admin page first.
          </p>
    ...
    <div className="space-y-6">
      ...
      <div className="bg-blue-500 bg-opacity-10 border border-blue-500 border-opacity-30 rounded-xl p-6">
        ...
        <div className="text-slate-300 space-y-2 text-sm">
          ...
          <p>
            <strong className="text-white">Data Source:</strong> Metrics are pulled from the GitHub Copilot Metrics API 
            via the <code className="px-1.5 py-0.5 bg-slate-700 rounded text-xs">copilot_dotcom_pull_requests</code> endpoint.
          </p>
        </div>
      </div>
    </div>
