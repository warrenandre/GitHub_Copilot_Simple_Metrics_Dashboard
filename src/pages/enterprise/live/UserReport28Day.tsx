...
const UserReport28Day = () => {
  ...
  const summaryMetrics = useMemo(() => {
    ...
    const totalCodeGeneration = filteredData.reduce(
      (sum, r) => sum + r.code_generation_activity_count,
      0
    );
    const totalAcceptance = filteredData.reduce(
      (sum, r) => sum + r.code_acceptance_activity_count,
      0
    );
    ...
    const totalLinesAdded = filteredData.reduce(
      (sum, r) => sum + r.loc_added_sum,
      0
    );
      ...
      <div className="p-8">
        <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg p-6">
          ...
          <p className="text-yellow-700 dark:text-yellow-300 mb-4">
            Please upload a user 28-day report from the Admin page to view
            visualizations.
          </p>
              ...
              tooltip={({ datum }) => (
                ...
                >
                  ...
                  <div style={{ color: "#9CA3AF" }}>
                    {(
                      (datum.value /
                        featureUsageData.reduce((sum, d) => sum + d.value, 0)) *
                      100
                    ).toFixed(1)}
                    %
                  </div>
              ...
              tooltip={({ datum }) => (
                ...
                >
                  ...
                  <div style={{ color: "#9CA3AF" }}>
                    {(
                      (datum.value /
                        modelUsageData.reduce((sum, d) => sum + d.value, 0)) *
                      100
                    ).toFixed(1)}
                    %
                  </div>
          ...
          <div className="h-80">
            <ResponsiveBar
              ...
              tooltip={({ id, value, indexValue, color }) => (
                ...
                >
                  <div style={{ color, fontWeight: 600 }}>{indexValue}</div>
                  <div style={{ color: "#F9FAFB", marginTop: "4px" }}>
